...
We take the security of `eslint-config-woofmeow` seriously. We appreciate your efforts to responsibly disclose your findings.
...
2. Click on **Report a vulnerability** (or use [this direct link](https://github.com/oleg-putseiko/eslint-config-woofmeow/security/advisories/new)).
...
3. Provide the following details:
   - The package version(s) affected (e.g., `2.0.0` or `2.0.0-canary.2`).
