---
name: Bug report
about: Create a report to help us improve the ESLint config
title: '[BUG] '
labels: bug
...
1. Install version '...' of `eslint-config-woofmeow`
...
<!-- A clear and concise description of what you expected to happen (e.g., "The rule `no-unused-vars` should not trigger on this specific syntax"). -->
