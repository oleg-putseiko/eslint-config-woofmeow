<!--
⚠️ IMPORTANT:
1. Your PR title MUST follow the Conventional Commits standard (e.g., "feat(react): add strict rules for react hooks").
2. Your PR MUST be targeted against the 'canary' branch. PRs targeting 'main' will be closed.
-->

📝 **Description**

<!-- Please include a summary of the changes and the related issue. Describe the rationale behind adding, modifying, or removing an ESLint rule. -->
